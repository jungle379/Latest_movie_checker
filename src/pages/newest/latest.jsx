    ...
    <>
      ...
      <main className="h-screen sm:bg-green-100">
        ...
        <div>
          ...
          <h2 className="sm:text-2xl mt-20 ml-10 sm:ml-40 text-indigo-500 hover:text-red-700">
            <Link href="https://wildspeed-official.jp">・ワイルドスピード/ジェットブレイク(公開中)</Link>
          </h2>
          <h3 className="sm:text-2xl mt-20 ml-10 sm:ml-40 text-indigo-500 hover:text-red-700">
