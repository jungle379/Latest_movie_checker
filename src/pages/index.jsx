      ...
      <main className="h-screen sm:bg-green-100">
        ...
        <div className="mt-36 flex h-20 bg-gray-200">
          ...
          <Link href="/archive/[page]" as="/archive/1">
            <h2 className="bg-center sm:text-2xl pt-5 hover:text-red-500 justify-between ml-20 mr-10 border-solid sm:border-4 sm:border-gray-400">今月公開予定の映画</h2>
          </Link>
          {/* </div>
        <div className="sm:mt-40"> */}
          <Link href="/near/map">
            <h3 className="bg-center sm:text-2xl pt-5 hover:text-red-500 justify-between ml-20 mr-10 border-solid sm:border-4 sm:border-gray-400">現在地から近くの映画館を探す</h3>
          </Link>
        </div>
        <div>
