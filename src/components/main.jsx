  ...
  return (
    <>
      ...
      <div className="sm:flex justify-around mt-20 h-96 sm:border-dashed sm:border-8 sm:border-red-400 mr-40 ml-40 pl-10 pr-10">
        ...
        <div className="mt-10">
          <Link href="../category">
            <h1 className="text-2xl sm:text-1xl mt-10 ml-10 m-5 w-80 underline hover:text-red-500 invisible sm:visible">
              ジャンル別オススメ映画
            </h1>
          </Link>
          <Link href="/">
            <h2 className="text-2xl sm:text-1xl mt-10 ml-10 m-5 w-80 underline hover:text-red-500 invisible sm:visible">
              アカデミー賞候補
            </h2>
          </Link>
          <Link href="/">
            <h3 className="text-1xl sm:text-1xl mt-10 ml-10 m-5 w-80 underline hover:text-red-500 invisible sm:visible">
              コロナウィルス対策について
            </h3>
          </Link>
        </div>
